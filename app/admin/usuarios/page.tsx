              ...
              <div className="space-y-4">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setEditingUser({ 
                          ...editingUser, 
                          plan: newPlan,
                          messagesLimit: PLAN_LIMITS[newPlan as keyof typeof PLAN_LIMITS] || 50
                        })
                      }}
                      className="w-full px-4 py-2 bg-[#0f0f0f] border border-gray-800 rounded-lg text-white focus:outline-none focus:border-blue-600"
                    >
                      <option value="FREE">FREE (50 mensajes)</option>
                      <option value="BETA">BETA (2,500 mensajes)</option>
                      <option value="PRO">PRO (500 mensajes)</option>
                      <option value="PREMIUM">PREMIUM (2,000 mensajes)</option>
                      <option value="ENTERPRISE">ENTERPRISE (10,000 mensajes)</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="bg-[#0f0f0f] border border-gray-800 rounded-lg p-3">
                  ...
                  <div className="text-lg font-semibold text-white">
                    {PLAN_LIMITS[editingUser.plan as keyof typeof PLAN_LIMITS] || 50} mensajes/mes
                  </div>
